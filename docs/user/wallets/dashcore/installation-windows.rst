...
``dashcore-22.1.2-win64-setup.exe.asc`` in the same folder as the
...
dashcore-22.1.2-win64-setup.exe with
dashcore-22.1.2-win64-setup.exe.asc`` then you have an authentic copy
