...
``dashcore-null-win64-setup.exe.asc`` in the same folder as the
...
dashcore-null-win64-setup.exe with
dashcore-null-win64-setup.exe.asc`` then you have an authentic copy
