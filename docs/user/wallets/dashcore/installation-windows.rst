...
``dashcore-23.0.0-win64-setup.exe.asc`` in the same folder as the
...
dashcore-23.0.0-win64-setup.exe with
dashcore-23.0.0-win64-setup.exe.asc`` then you have an authentic copy
