...
copy the necessary files to the directory and set them as executable::
  ...
  mkdir ~/.dashcore
  tar xfvz dashcore-18.1.0-x86_64-linux-gnu.tar.gz
  cp dashcore-18.1.0/bin/dashd .dashcore/
  cp dashcore-18.1.0/bin/dash-cli .dashcore/

Clean up unneeded files::

  rm dashcore-18.1.0-x86_64-linux-gnu.tar.gz
  rm -r dashcore-18.1.0/
