...
**Ctrl + V**::
  ...
  cd ~
  wget https://github.com/dashpay/dash/releases/download/v0.0.1/dashcore-0.0.1-x86_64-linux-gnu.tar.gz
...
::
  ...
  wget https://github.com/dashpay/dash/releases/download/v0.0.1/dashcore-0.0.1-x86_64-linux-gnu.tar.gz.asc
  gpg --verify dashcore-0.0.1-x86_64-linux-gnu.tar.gz.asc
...
copy the necessary files to the directory and set them as executable::
  ...
  mkdir ~/.dashcore
  tar xfvz dashcore-0.0.1-x86_64-linux-gnu.tar.gz
  cp dashcore-0.0.1/bin/dashd .dashcore/
  cp dashcore-0.0.1/bin/dash-cli .dashcore/

Clean up unneeded files::

  rm dashcore-0.0.1-x86_64-linux-gnu.tar.gz
  rm -r dashcore-0.0.1/
