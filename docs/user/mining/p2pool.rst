...
**Ctrl + V**::
  ...
  cd ~
  wget https://github.com/dashpay/dash/releases/download/v23.1.2/dashcore-23.1.2-x86_64-linux-gnu.tar.gz
...
::
  ...
  wget https://github.com/dashpay/dash/releases/download/v23.1.2/dashcore-23.1.2-x86_64-linux-gnu.tar.gz.asc
  gpg --verify dashcore-23.1.2-x86_64-linux-gnu.tar.gz.asc
...
copy the necessary files to the directory and set them as executable::
  ...
  mkdir ~/.dashcore
  tar xfvz dashcore-23.1.2-x86_64-linux-gnu.tar.gz
  cp dashcore-23.1.2/bin/dashd .dashcore/
  cp dashcore-23.1.2/bin/dash-cli .dashcore/

Clean up unneeded files::

  rm dashcore-23.1.2-x86_64-linux-gnu.tar.gz
  rm -r dashcore-23.1.2/
