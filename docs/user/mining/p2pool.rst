...
**Ctrl + V**::
  ...
  cd ~
  wget https://github.com/dashpay/dash/releases/download/v22.1.3/dashcore-22.1.3-x86_64-linux-gnu.tar.gz
...
::
  ...
  wget https://github.com/dashpay/dash/releases/download/v22.1.3/dashcore-22.1.3-x86_64-linux-gnu.tar.gz.asc
...
copy the necessary files to the directory and set them as executable::
  ...
  mkdir ~/.dashcore
  tar xfvz dashcore-22.1.3-x86_64-linux-gnu.tar.gz
  cp dashcore-22.1.3/bin/dashd .dashcore/
  cp dashcore-22.1.3/bin/dash-cli .dashcore/

Clean up unneeded files::

  rm dashcore-22.1.3-x86_64-linux-gnu.tar.gz
  rm -r dashcore-22.1.3/
