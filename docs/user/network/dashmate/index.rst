...
page <https://github.com/dashpay/platform/releases/latest>`__::
   ...
   wget https://github.com/dashpay/platform/releases/download/v2.1.2/dashmate_2.1.2.f49390fb4-1_amd64.deb

Install dashmate using apt::

   sudo apt update
   sudo apt install ./dashmate_2.1.2.f49390fb4-1_amd64.deb
...
.. note:: At the end of the installation process, ``apt`` may display an error due to installing a downloaded package. You can ignore this error message:
   ...
   ``N: Download is performed unsandboxed as root as file '/home/ubuntu/dashmate_2.1.2.f49390fb4-1_amd64.deb' couldn't be accessed by user '_apt'. - pkgAcquire::Run (13: Permission denied)``
