...
follows::
  ...
  cd /tmp
  wget https://github.com/dashpay/dash/releases/download/v20.1.0/dashcore-20.1.0-$(uname -m)-linux-gnu.tar.gz
...
::
  ...
  wget https://github.com/dashpay/dash/releases/download/v20.1.0/dashcore-20.1.0-$(uname -m)-linux-gnu.tar.gz.asc
  gpg --verify dashcore-20.1.0-$(uname -m)-linux-gnu.tar.gz.asc

Extract the compressed archive and copy the necessary files to the
directory::

  tar xfv dashcore-20.1.0-$(uname -m)-linux-gnu.tar.gz
  sudo install -t /usr/local/bin dashcore-20.1.0/bin/*
