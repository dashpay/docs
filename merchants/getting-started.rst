...
+------------------------------------------------+-------------+-------------+----------+
| `GoURL <https://gourl.io>`_                    | Check       | |checkmark| |          |
+------------------------------------------------+-------------+-------------+----------+
| `GoCoin <https://gocoin.com>`_                 | Check       | U+02713     |          |
+------------------------------------------------+-------------+-------------+----------+
| `CopPay <https://coppay.io>`_                  | Check       | U+02714     |          |
+------------------------------------------------+-------------+-------------+----------+
| `PayBear <https://www.paybear.io>`_            | Check       | \|check\|   |          |
+------------------------------------------------+-------------+-------------+----------+
