...
score, which is equal to the number of masternodes in the registered set. If
the score reaches the number of masternodes in the registered set, a PoSe ban
