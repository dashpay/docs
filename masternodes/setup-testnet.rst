...
key generated by ``mn setup``, this information is already configured
for your masternode. If you generated your own BLS key pair, edit the
mn-bootstrap configuration as follows::
...
mn-bootstrap as follows::

  git clone -b v0.19-dev https://github.com/dashevo/mn-bootstrap.git
  cd mn-bootstrap
