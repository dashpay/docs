...
following commands (example for Linux)::
  ...
  wget https://github.com/akhavr/electrum-dash/releases/download/3.3.8.1/Dash-Electrum-3.3.8.1.tar.gz
  wget https://github.com/akhavr/electrum-dash/releases/download/3.3.8.1/SHA256SUMS.txt.asc
  sha256sum Dash-Electrum-3.3.8.1.tar.gz
...
from the source tarball::
  ...
  wget https://github.com/akhavr/electrum-dash/releases/download/3.3.8.1/Dash-Electrum-3.3.8.1.tar.gz
  tar -zxvf Dash-Electrum-3.3.8.1.tar.gz
  cd Dash-Electrum-3.3.8.1
