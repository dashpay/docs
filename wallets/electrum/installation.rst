...
following commands (example for Linux)::
  ...
  wget https://github.com/akhavr/electrum-dash/releases/download/3.3.8/Dash-Electrum-3.3.8.tar.gz
  sha256sum https://github.com/akhavr/electrum-dash/releases/download/3.3.8/Dash-Electrum-3.3.8.tar.gz
  wget https://github.com/akhavr/electrum-dash/releases/download/3.3.8/SHA256SUMS.txt.asc
...
from the source tarball::
  ...
  wget https://github.com/akhavr/electrum-dash/releases/download/3.3.8/Dash-Electrum-3.3.8.tar.gz
  tar -zxvf Dash-Electrum-3.3.8.tar.gz
  cd Dash-Electrum-3.3.8
